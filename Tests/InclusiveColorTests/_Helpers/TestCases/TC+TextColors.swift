...
extension ICTestCases.TextColors {
    ...
    static func case1() -> [ICColorVisionType : [ICTextColorsComparison<ICSRGBA>]] {
        let c1 = [
            ICTextColorsComparison(text: test1[0].text,
                                 bg: test1[0].bg,
                                 font: test1[0].font,
                                 score: 1.0060028,
                                 didPass: false,
            ...
            ICTextColorsComparison(text: test1[1].text,
                                 bg: test1[1].bg,
                                 font: test1[1].font,
                                 score: 10.573096,
                                 didPass: true,
        ...
        var comparisons: [ICColorVisionType : [ICTextColorsComparison<ICSRGBA>]] = [:]
