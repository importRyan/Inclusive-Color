...
public extension Dictionary where Key == ICColorVisionType {
    ...
    where Value == [ICAssessment.MeaningfulColors<C>.Comparison] {
        ...
        return (overall: ICAssessment.Statistics(
                    didFailCount: failureCount,
...
public extension Array {
    ...
    where Element == ICAssessment.MeaningfulColors<C>.Comparison {
        ...
        return ICAssessment.Statistics(
            didFailCount: failureCount,
            didPassCount: passCount,
            totalComparisons: comparisonsCount,
